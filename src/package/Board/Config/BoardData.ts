...
export type BoardGeneralData = {
  startAs?: FigureColor
}

type DataConstructor = BoardGeneralData &
  (
...
class BoardData implements Data {
  ...
  public startAs: FigureColor = 'White' as const
  ...
  constructor(data: DataConstructor) {
    ...
    if (data.type === 'BoardGui') {
      this.startAs = data.startAs ?? 'White'
    }
